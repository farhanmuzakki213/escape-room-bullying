<div class="bg-gray-800 min-h-screen flex items-center justify-center">
    ...
    <div class="relative w-full max-h-full aspect-video">
        ...
        <img src="{{ asset('images/petamisi/background-peta-misi.jpg') }}" alt="Background Peta Misi"
        ...
        <div
            ...
            <img src="{{ asset('images/petamisi/number-1.png') }}" alt="Nomor 1" class="w-[25%] pointer-events-none">
            <button wire:click="selectLevel(1)" class="w-[70%] hover:scale-110 transition-transform">
                <img src="{{ asset('images/petamisi/meja-belajar.png') }}" alt="Level 1: Kelas">
            </button>
        </div>
        ...
        <div
            ...
            <img src="{{ asset('images/petamisi/number-3.png') }}" alt="Nomor 3" class="w-[25%] pointer-events-none">
            <button wire:click="selectLevel(3)" class="w-[70%] hover:scale-110 transition-transform"
                ...
                <img src="{{ asset('images/petamisi/locker-bola.png') }}" alt="Level 3: Lorong"
        ...
        <div
            ...
            <img src="{{ asset('images/petamisi/number-4.png') }}" alt="Nomor 4" class="w-[25%] pointer-events-none">
            <button wire:click="selectLevel(4)" class="w-[60%] hover:scale-110 transition-transform"
                ...
                <img src="{{ asset('images/petamisi/tiang-bendera-v1.png') }}" alt="Level 4: Lapangan"
